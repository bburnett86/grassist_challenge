GRASSIST.planner = function() {
    ...
    var avoidFlowerWest = function(lawnmower, yard) {
        debugger;
        if ((westPatchType(lawnmower, yard) === "plant_flower") && (southPatchType(lawnmower, yard) === "plant_flower")) {
            lawnmower.turnRight()
        }
        lawnmower.turnLeft().turnLeft();
    ...
    var avoidFlowerSouth = function(lawnmower, yard) {
        ...
        while (southPatchType(lawnmower, yard) === "plant_flower") {
            if (southPatchType(lawnmower, yard) === "plant_flower" && westPatchType(lawnmower, yard) === "plant_flower") {
                lawnmower.turnRight()
                return;
            }
            westMovement(lawnmower, yard);
    ...
    // Missed Grass
    var missedGrass = function(lawnmower, yard) {
        return (southPatchType(lawnmower, yard) === "long_grass" ? true : false)
    }

    var catchStrays = function(lawnmower, yard) {
        lawnmower.turnRight();
        southMovement(lawnmower, yard);
        lawnmower.turnLeft();
        while (eastPatchType(lawnmower, yard) !== "plant_flower") {
        ...
        while (westPatchType(lawnmower, yard) !== "plant_flower") {
            westMovement(lawnmower, yard);
        }
        westMovement(lawnmower, yard)
        if (yard.freshlyCut()) {
    ...
    var plan = function(lawnmower, yard) {
        ...
        while (yard.freshlyCut() != true) {
            ...
            while (lawnmower.heading() === "east") {
                ...
                if (missedGrass(lawnmower, yard)) {
                    catchStrays(lawnmower, yard);
                }
                if (yard.freshlyCut()) {
                    break;
                }
